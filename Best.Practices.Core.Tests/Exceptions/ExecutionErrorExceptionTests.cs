...
{
    public class ExecutionErrorExceptionTests
    {
        public ExecutionErrorExceptionTests()
        {
        }
        ...
        {
            //Act
            var exception = new ExecutionErrorException("Message Test");
        ...
        {
            //Act
            var exception = new ExecutionErrorException(new ErrorMessage("Message Test"));
        ...
        public void Constructor_GivenAErrorListParameter_InstantiateErrorList()
        {
            ...
            //Act
            var exception = new ExecutionErrorException(errorList);
